...
Table4 = rbind(BIC.mean[1,], freq_best[1,], BIC.mean[2,], freq_best[2,], BIC.mean[3,], freq_best[3,], 
               BIC.mean[4,], freq_best[4,], BIC.mean[5,], freq_best[5,])
rownames(Table4) = c("BIC_g=1", "freq_=g=1", "BIC_g=2", "freq_=g=2", "BIC_g=3", "freq_=g=3", "BIC_g=4", "freq_=g=4","BIC_g=5", "freq_=g=5")
