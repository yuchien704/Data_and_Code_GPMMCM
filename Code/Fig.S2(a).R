...
true_clus = rep(c(1,2,3), each = ni[1])
...
postscript(paste(SPATH, '/Results/Fig.S2(a).eps', sep=''), width=10, height=10) # break = 20
...
title('(a) Poorly separated mixture samples', outer=T, line=-1)
dev.off()
